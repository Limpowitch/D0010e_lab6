...
/**
 * Optimize klassen ansvarar for att optimera simuleringen.
 *
...
public class Optimize {
    ...
    /**
     * Returnerar antalet missade kunder baserat pa vilket fro som simulatorn skapas med.
	...
	/**
	 * Denna metod ska steppa från 1 kassa till max antal kunder i butiken och hitta det optimala antalet kassor
	 * baserat på ett specifikt fro.
	 * @param seed
	 * @return
	 */
	public int loopThroughCapacity(int seed)
	{
	...
	/**
	 * Denna metod använder loopThroughCapacity och ansvarar för att undersoka vilket fro, dvs i forlangningen
	 * vilka parametrar, som kommer ge best affarsresultat.
	 * @param seed
	 */
